				...
				<div class="menu-item-handle">
					...
					<span class="item-controls">
						...
						<span class="item-order hide-if-js">
							...
							?>" class="item-move-up"><abbr title="<?php esc_attr_e( 'Move up', 'reino' ); ?>">&#8593;</abbr></a>
							|
							<a href="<?php
								echo wp_nonce_url(
									add_query_arg(
						...
						<a class="item-edit" id="edit-<?php echo esc_attr( $object_id ); ?>" title="<?php esc_attr_e( 'Edit Menu Item', 'reino' ); ?>" href="<?php
